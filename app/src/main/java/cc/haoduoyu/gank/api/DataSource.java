...
import cc.haoduoyu.gank.mvp.model.GankData;
import cc.haoduoyu.gank.mvp.model.GirlData;
import cc.haoduoyu.gank.mvp.model.VideoData;
...
/**
 * 用于给
 * {@link cc.haoduoyu.gank.injector.modules.AppModule#provideGankApiCommon(DataSource)}
 * 使用
